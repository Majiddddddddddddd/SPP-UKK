...
Public Class TransaksiPetugas
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        e.Graphics.DrawString("jumlah bayar", f10, Brushes.Black, 95, 95)
        ...
        For baris As Integer = 0 To dgv_user.RowCount - 1
            ...
            e.Graphics.DrawString(dgv_user.Rows(baris).Cells(7).Value.ToString, f10, Brushes.Black, 95, 100 + tinggi)
